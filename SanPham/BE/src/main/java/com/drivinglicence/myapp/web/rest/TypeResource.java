...
/**
 * REST controller for managing {@link com.drivinglicence.myapp.domain.Type}.
 */
@RestController
@RequestMapping("/api")
public class TypeResource {
    ...
    public ResponseEntity<TypeDTO> updateType(@PathVariable(value = "id", required = false) final Long id, @RequestBody TypeDTO typeDTO)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TypeDTO> partialUpdateType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeDTO.getId().toString())
        );
    }
    ...
    public Result deleteType(@PathVariable Long id) {
        ...
        Result result = typeService.deleteType(id);
        return result;
