...
import com.example.drivinglicenceadmin.databinding.ActivityUserProfileBinding
...
class UserProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setUserData()
//        if(user.equals("user")){
//            binding.imgEditPhoneNumber.visibility = View.GONE
//            binding.imgEditEmail.visibility = View.GONE
//            binding.imgEditImage.visibility = View.GONE
...
//        }
        ...
        binding.btEdit.setOnClickListener {
            if(edit_avatar){
                ...
                Log.d("TAG", "edit: ${account.imageUrl}")
            }
            if(edit_email){
...
//        }
        ...
        userViewModel.updateUser("Bearer ${token}", account).observe(this) {
            it?.let { resource ->
                when (resource.status) {
                    Status.SUCCESS -> {
